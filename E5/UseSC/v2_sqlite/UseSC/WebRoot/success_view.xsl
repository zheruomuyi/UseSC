        ...
        <html>  
            ...
            <body>  
		        ...
		        <input> 
		        	 ...
		        	 <xsl:attribute name="value"><xsl:value-of select="view/body/form/buttonView/value"/></xsl:attribute>      
		        	 <xsl:attribute name="type"><xsl:value-of select="view/body/form/buttonView/type"/></xsl:attribute>      
		        </input>
          	</form>
          </body>  
        </html>  
